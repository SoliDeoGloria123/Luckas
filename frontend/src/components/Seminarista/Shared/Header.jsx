...
import NotificationCenter from '../../notificaciones/seminarista/NotificationCenter';
import './Header.css';
...
const Header = ({ user, breadcrumbPath, onTabChange }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      // NO cerrar si el clic es dentro del panel de notificaciones
      if (event.target.closest('[data-notification-panel-seminarista]')) return;

      // NO cerrar si el clic es en el botón de notificaciones
      if (event.target.closest('[data-notification-toggle]')) return;

      // Cerrar Mis Gestiones
      if (
          ...
          <div className="header-right-seminario">
            ...
            <div className="header-icons-seminario">
              <div className="notification-center-wrapper">
                <NotificationCenter userId={usuarioLogueado?._id} />
              </div>
            </div>
