...
// Ruta estadisticas (debe ir antes de rutas con parámetros)
router.get('/estadisticas', role.checkRole('admin', 'tesorero', 'seminarista'), reservasController.obtenerEstadisticasReservas);
...
// Obtener Reserva por usuarios
router.get('/usuario/:userId', reservasController.obtenerReservasPorUsuario);

// Desactivar y activar reserva (solo admin, tesorero)
router.patch('/toggle-activation/:id', role.checkRole('admin', 'tesorero'), reservasController.toggleReservaActivation);
